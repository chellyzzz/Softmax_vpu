...
class CpuCore extends Module with Parameter {
  ...
  val ifu_pc_next = Wire(UInt(DataWidth.W))
  ...
  val  ifu2idu_ins          = Wire(UInt(32.W)) 
  ...
  idu2ifu_ready:=  idu2exu_regs.io.out.pre_ready   
  idu2exu_valid:=  idu2exu_regs.io.out.post_valid  
